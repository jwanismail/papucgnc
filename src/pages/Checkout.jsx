...
export default function Checkout() {
  ...
  // Kampanya indirimi hesaplama (Cart.jsx'deki ile aynı)
  ...
  const shipping = discountedSubtotal >= 1500 ? 0 : 99;
        ...
        <div className="checkout-layout">
                  ...
                  <div className="payment-option">
                    ...
                    <label htmlFor="kapida" className="payment-label">
                      ...
                      <div className="payment-info">
                        ...
                        <p>Nakit veya kart ile kapıda ödeme /kart ödeme</p>
                      </div>
                    </label>
                  </div>
                ...
                {paymentMethod === 'eft' && (
                  <div className="eft-info">
                    ...
                    <div className="bank-details">
                      ...
                      <p><strong>IBAN:</strong> TR360006400000114560353675</p>
                      <p><strong>Alıcı:</strong> Civan Elismail</p>
          ...
          <div className="order-summary">
            ...
            <div className="order-totals">
              ...
              {campaignDiscount > 0 && (
                <div className="total-row campaign-discount">
